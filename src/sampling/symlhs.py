...
def symlhs(sp:int, params:int, criterion:str='maximin', iterations=10:int): -> np.ndarray
    '''
    Description:
    ------------
    This function optimizes the produced symLHS array 
    ...
    if criterion == 'maximin':
        ...
        for it in range(iterations):
            ...
            if new_cost_func > best_sample_cost:
                best_sample = new_sample
                best_sample_cost = new_cost_func
        ...
        for it in range(iterations):
            ...
            # check the cost function value
            if new_cost_func < new_sample_cost:
                best_sample = new_sample
                best_sample_cost = new_cost_func
